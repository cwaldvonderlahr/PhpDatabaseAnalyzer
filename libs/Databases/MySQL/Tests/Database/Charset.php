<?php
/**
 * Mysqli Database Charset Test Class
 *
 * @category  Database
 ...
 * @version   0.1
 **/
namespace PhpDatabaseAnalyzer\Databases\Mysql\Tests\Database;

class Database implements \PhpDatabaseAnalyzer\DatabaseTestInterface
{
